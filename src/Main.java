            ...
            System.out.println("[4].Player Stats/Player Inventory;");
                switch(takeInput()){
                    ...
                    case 4:
                        ...
                        System.out.println(String.format("* Name: %s", p1.name));
                        System.out.println(String.format("* Level: %d, %d/%d EXP", p1.level, playerEXP,  levelEXP));
                        System.out.println(String.format("* Max HP : %d", p1.hpCap));
                        System.out.println(String.format("* Current HP : %d", p1.HP));
                        System.out.println("-INVENTORY-");
                        System.out.println(String.format("* %d MedKits", medKitAmount));
                        System.out.println(String.format("* %d Oreo Cookies\n", oreoCookieAmount));
                        TimeUnit.MILLISECONDS.sleep(2000);
                        break;
